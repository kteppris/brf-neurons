...
from brf_snn.functional import FGI_DGaussian, StepDoubleGaussianGrad
...
def rf_update(
    ...
    # generate spike
    # z = StepDoubleGaussianGrad.apply(u.real - theta)
...
def izhikevich_update(
    ...
    # generate spike
    z = StepDoubleGaussianGrad.apply(u.imag - theta)
