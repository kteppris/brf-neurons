...
from brf_snn.functional import StepLinearGrad, quantize_tensor
################################################################
# Neuron update functional
################################################################


DEFAULT_LI_TAU_M = 20.0
DEFAULT_LI_ADAPTIVE_TAU_M_MEAN = 20.0
DEFAULT_LI_ADAPTIVE_TAU_M_STD = 5.0

DEFAULT_LIF_TAU_M = 20.0
DEFAULT_LIF_ADAPTIVE_TAU_M_MEAN = 20.0
DEFAULT_LIF_ADAPTIVE_TAU_M_STD = 5.0
...
def lif_update(
    ...
    # generate spike.
    z = StepLinearGrad.apply(u - theta)
